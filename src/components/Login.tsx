          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-5 py-4 pr-12 text-base border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none transition-all"
                placeholder="••••••••"
                required
              />
              <button
